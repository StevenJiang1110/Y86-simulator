...
public class Pipeline{
	...
	void Memory_Write()
    {
        if (mem_write)
        {
            ...
            Memory[Math.floorMod(mem_addr+2, MEMORY_SIZE)] = (byte)(M_valA >> 16);
            Memory[Math.floorMod(mem_addr+3, MEMORY_SIZE)] = (byte)(M_valA >> 24);
        }
    }
	...
	void Memory_Read()
    {
        ...
        if (mem_read)
        {
            ...
            {
                a1 = Memory[Math.floorMod(mem_addr, MEMORY_SIZE)];
                a2 = Memory[Math.floorMod(mem_addr+1, MEMORY_SIZE)];
                a3 = Memory[Math.floorMod(mem_addr+2, MEMORY_SIZE)];
